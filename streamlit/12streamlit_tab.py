...
with tab2:
    ...
    # 모달리스는 대화상자가 열려있는 동안 사용자는 다른 화면 조작 가능
...
# 시간을 지속적으로 업데이트하기 위한 무한 루프
    ...
    if show_clock:
        # 자동으로 페이지를 일정 간격으로 새로 고침하게 해주는 함수
        # 실시간 데이터 표시, 시계, 알람, 센서 값 등 주기적 업데이트가 필요한 경우 유용
...
with tab5:
    ...
    if go_download:
        ...
        def download_file(url, filename):
            ...
            # 쿠키 헤더 인증 등 웹과 관련딘 복잡한 작업을 수행
            # 사용시 브라우저 헤더를 반드시 설정할 것!!(우리 사이트 정보를 빼내려하나는 오해 불식시키려)
        ...
        download_file('https://thumbnews.nateimg.co.kr/view610///news.nateimg.co.kr/orgImg/pt/2024/05/31/202405311915778523_6659a350aad3b.jpg', 'suji.jpg')
